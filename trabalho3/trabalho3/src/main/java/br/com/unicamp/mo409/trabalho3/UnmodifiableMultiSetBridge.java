...
public class UnmodifiableMultiSetBridge {
    ...
    public UnmodifiableMultiSetBridge(MultiSet<Pessoa> multiset) {
    ...
    public boolean contains(final Pessoa pessoa) {
        return unmodifiableMultiSet.contains(pessoa);
    }

    public boolean containsAll(final Collection<?> coll) {
        return unmodifiableMultiSet.containsAll(coll);
    }

    public int size() {
        return unmodifiableMultiSet.size();
    }
